...
fig.append( glucifer.objects.Points(gSwarm, viscosityMapFn, logScale=True, valueRange =[1e-1,1e5]))
...
if figures == 'gldb':
    ...
    figVisc.append( glucifer.objects.Points(vSwarm,viscosityMapFn, logScale=True, valueRange =[1.,1e5]))
