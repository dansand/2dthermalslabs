...
dp = edict({#Main physical paramters
           ...
           'Adf':5.34e-10,             #1./1.87e9, pre-exp factor for diffusion creep
           ...
           'Vds':0.9*12e-6,
           'Vpr':10e-6,
           'Alm':4.2372881355932205e-15,   #1./2.36e14
           'Elm':2.0e5,
           'Vlm':1.5e-6,
...
##############
#Set up slab viscosity reduction - 
##############
...
if md.slabViscWeakening:
    ...
    slabViscReduceFn  = fn.branching.conditional([( operator.and_(temperatureField < tempViscReduction, depthFn > depthViscReduction)
    , md.viscReduceFac),
...
if md.slabPlasWeakening:
    ...
    slabStressMaxReduceFn  = fn.branching.conditional([( operator.and_(temperatureField < tempViscReduction, depthFn > depthViscReduction)
...
#fig.append( glucifer.objects.VectorArrows(mesh,velocityField, scaling=0.002))
#fig.append( glucifer.objects.Surface(mesh,depthFn))
#fig.append( glucifer.objects.Surface(mesh,raylieghFn))
